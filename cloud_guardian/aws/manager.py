...
class AWSManager:
    ...
    def store_credentials(self, identity_arn, credentials):
        ...
        if credentials and isinstance(credentials, ReadOnlyCredentials):
            self.credentials[identity_arn] = {
            ...
            logger.warning(f"No valid credentials found for {identity_arn}.")
