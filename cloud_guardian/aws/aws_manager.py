...
import boto3
from cloud_guardian.aws.helpers.iam.group_management import (
    create_group, 
)
from cloud_guardian.aws.helpers.iam.policy_management import (
    create_policy, attach_policy_to_group, attach_policy_to_user,
)
from cloud_guardian.aws.helpers.iam.role_management import (
    create_role,
)
...
class AWSManager:
    ...
    folder_path
        ...
        for role in roles_dict["Roles"]:
            ...
            role_arn = create_role(self.iam, role_name, role["AssumeRolePolicyDocument"])
