...
from cloud_guardian.iam_static.graph.relationships.relationships import Relationship
...
class IAMGraph:
    ...
    def get_entity_by_name(
        ...
        if len(nodes) == 0:
            ...
            raise ValueError(f"Multiple entities with name {name} found in the graph")
        return nodes[0]
