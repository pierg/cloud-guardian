...
def load_classes_from_json(json_file_path: str) -> Tuple[Dict[str, Dict[str, IAMActionType]], List[IAMActionType]]:
    try:
        with open(json_file_path, "r") as file:
            ...
            for category, actions in data["actions"].items():
                ...
                for action_id, attrs in actions.items():
                    action_type = IAMActionType.create_from_dict(action_id, {
                        "id": action_id,
                        "category": category,
                        **attrs
                    })
